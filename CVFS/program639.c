...
void ManPageDisplay(char Name[])  // man page 
{
    if(strcmp(Name,"exit") == 0)
    {
        printf("About :it is use to terminate the Project\n");
        printf("Usage : exit \n");
    ...
    {
        printf("About :it is use to  list all files from current Directory\n");
        printf("Usage : ls\n");
    }
    else if(strcmp(Name,"ls") == 0)
    {
